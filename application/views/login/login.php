<section>
  <form id="loginForm" action="<?php echo site_url('validate-login')?>" class="form-signin" _lpchecked="1" method="POST">
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button><a class="btn btn-lg btn-secondary btn-block" href="<?php echo site_url('register'); ?>">Sign Up</a>
